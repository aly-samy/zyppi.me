...
## Out of Scope
Runtime implementation, domain models, API code, any package's internal source files beyond an empty scaffold, CI workflow *content* (that's IT-0107/0108) — this task creates the shape, not the tooling behavior.
