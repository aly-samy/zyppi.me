...
- **Repository Return Implications:** Using this type directly as the repository return type could improperly imply that retrieval has already performed Runtime resolution or activation checks. Deciding whether the repository should return this direct type or an intermediate retrieved graph is an open contract-design question for AMS-0502. [CURRENT SOURCE FACT]
...
| **AMS-0502-PREP-D04** | Incomplete State Semantics    | Checked during Runtime resolution.                | The repository reports what was retrieved. Runtime determines constitutional incompleteness.                           | IMPLEMENTATION/CONTRACT DESIGN QUESTION | No (AMS-0502 scope)     |
