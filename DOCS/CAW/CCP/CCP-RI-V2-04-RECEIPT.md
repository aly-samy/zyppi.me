...
| `V204-T28` | V1 Preservation  | V1 dispatch preserves exact `@zyppi/domain` `validateExecutionRequest` value | PASS   |
...
- `pnpm test`: PASS (1245 unit/integration tests passing)
