...
*(All CAW-003 entities. Requires: M02.)*
...
*(Requires: M03. Can run parallel with M04.)*
...
*(Requires: M03, M05. Can run parallel with M06.)*
...
*(Requires: M08. Runs alongside M09–M11.)*
