# Unfict Information Architecture Bible
...
This document defines how Unfict represents, stores, derives, and governs information.

The **North Star** defines **why Unfict exists**.

The **Founding Principles** define **what Unfict believes**.

The **Product Requirements Document** defines **what Unfict builds**.

The **Technical Architecture Bible** defines **how Unfict executes**.

The **Information Architecture Bible** defines **how Unfict understands reality**.
...
Every interaction within Unfict follows the same immutable information lifecycle.
...
Everything else within Unfict derives from these five primitives.
...
Information governance ensures that Unfict remains trustworthy over time.
...
The enduring asset of Unfict is not software.
