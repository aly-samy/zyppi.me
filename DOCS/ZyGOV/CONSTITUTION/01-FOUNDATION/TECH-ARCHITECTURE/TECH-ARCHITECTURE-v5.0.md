# Unfict Technical Architecture Bible

# Constitutional Metadata Compilation: Unfict Technical Architecture Bible v5.0
...
| Document ID         |                                                                                                                                                                                 |
| Constitutional URI  |                                                                                                                                                                                 |
| Canonical Name      | UNFICT_TECHNICAL_ARCHITECTURE_BIBLE_v5.0                                                                                                                                        |
| Document Family     | Unfict Constitutional Corpus                                                                                                                                                    |
| Title               | Unfict Technical Architecture Bible                                                                                                                                             |
| Version             | 5.0                                                                                                                                                                             |
...
| Parent Document     | FOUNDING-PRINCIPLES-v6.0.md (nearest constitutional parent)                                                                                                                     |
| Depends On          | NORTH-STAR-v8.0.md, FOUNDING-PRINCIPLES-v6.0.md, PRD-v5.0.md                                                                                                                    |
...
| Supersedes          | ZYPPI_TECHNICAL_ARCHITECTURE_BIBLE_v4.2                                                                                                                                         |
...
| Change Log          | Version 5.0: Adopte the new brand name "Unfict".                                                                                                                                |
...
This document defines the constitutional architecture of Unfict.

The North Star explains **why Unfict exists.**

The Founding Principles explain **how Unfict must evolve.**

The PRD explains **what Unfict builds.**

The Technical Architecture Bible explains **how Unfict is engineered.**
...
Every engineering decision must move Unfict toward becoming the Universal Trust Execution Platform.

---

# 1. Architecture Philosophy

Unfict is not a website.

Unfict is not a dashboard.

Unfict is not a CMS.

Unfict is not a Digital Product Passport platform.

Unfict is not an ERP.

Unfict is the **Identity and Routing Layer for Physical Products.**
...
```
Routing is Unfict's primary workload.
...
The Decision Engine is Unfict's core.
...
Exposes Unfict to the outside world.
...
Unfict stores destination references.
...
When no customer destination exists, Unfict renders a lightweight fallback page.
...
Today's Unfict routes users to the correct destination.
