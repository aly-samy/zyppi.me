...
**Effective Date:** `NONE until ratified`  
...
**v0.3 corrective scope:** Standard-Readiness Review correction to mask-candidate scoring order only. It does not broaden FQR-1.
...
If a standards-sensitive technical fact is contradicted by the final human normative-verification record, this draft SHALL be corrected before ratification.
...
This v0.3 specification is the principal candidate output of:
...
Standard-Readiness Review    READY — CHAIR ACCEPTANCE PENDING
