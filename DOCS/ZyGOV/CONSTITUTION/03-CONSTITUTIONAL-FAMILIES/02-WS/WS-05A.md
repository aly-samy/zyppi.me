...
_Schema/Runtime Firewall:_ during Master Registry Population, canonical entity definitions SHALL NOT contain hardcoded references to runtime entity instances (e.g., a canonical Contract template SHALL NOT require a specific runtime CL-04 identity_id for admission).
