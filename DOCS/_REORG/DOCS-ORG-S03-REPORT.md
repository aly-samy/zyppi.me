...
| C06 | `DOCS/ZyGOV/CONSTITUTION/03-CONSTITUTIONAL-FAMILIES/02-WS/WS-03.md`                                       | WS-03 Entity Taxonomy & Hierarchy Validation                             | Version: 1.0 (LOCKED), Status: APPROVED | Explicitly superseded by `WS-03 Revision 1.md` (which is separately CANONICAL-ACTIVE).                                                                      | `RECONCILED-SUPERSEDED/HISTORICAL` | HELD IN PLACE (Deferred to S14) | None — explicit supersession established by WS-03 Revision 1.               |
...
| C08 | `DOCS/ZyGOV/CONSTITUTION/03-CONSTITUTIONAL-FAMILIES/02-WS/WS-03A.2.md`                                    | WS-03A.2 — Hierarchy Classification Framework                            | Status: LOCKED, Version: 1.0            | Explicitly superseded by `WS-03A.2 Revision 1.md` (which is separately DRAFT in Lane B).                                                                    | `RECONCILED-SUPERSEDED/HISTORICAL` | HELD IN PLACE (Deferred to S14) | None — base version superseded by Revision 1.                               |
...
Lane C reconciled superseded/historical = 2
Lane C unresolved requires Chair = 7
...
5. **Exact Number of Unknowns Resolved:** 9 (0 active, 0 draft, 2 superseded/historical, 7 unresolved requires Chair).
